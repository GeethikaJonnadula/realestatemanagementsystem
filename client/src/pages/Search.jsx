...
export default function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen bg-gradient-to-r from-purple-400 to-purple-600'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <button className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-95 transition duration-300'>
            Search
          </button>
        </form>
      </div>
      <div className='flex-1'>
        ...
        style={{
          backgroundImage: `url('https://i.ytimg.com/vi/G3gcEt8SRLQ/maxresdefault.jpg')`,
          ...
          {showMore && (
            <button
              ...
              className='text-green-700 hover:underline p-7 text-center w-full transition duration-300'
            >
              Show more
            </button>
          )}
